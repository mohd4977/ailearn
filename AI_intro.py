...
#Following code is from the LangChain course by Aurelio.
#This code is used to set up the environment for LangChain and define some basic tools.
...
openai_model = "gpt-4o-mini"  # You can change this to "gpt-3.5-turbo" or any other model you prefer

#Setting up OpenAI

from langchain_openai import ChatOpenAI

#For normal accurate response, set temperature to 0.0
llm = ChatOpenAI(model=openai_model, temperature=0.0)  # Set temperature to 0.0 for deterministic output

#For unique and creative responses, set temperature to 0.9
creative_llm = ChatOpenAI(model=openai_model, temperature=0.9)
